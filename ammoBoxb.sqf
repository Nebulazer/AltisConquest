...
_crate addWeaponCargoGlobal ["rhs_weap_pkp", 1];
...
_crate addMagazineCargoGlobal ["rhs_100Rnd_762x54mmR", 2];
...
//_crate addItemCargoGlobal ["rhsusf_acc_ACOG_PIP", 1]; 
//_crate addItemCargoGlobal ["rhsusf_acc_EOTECH", 1]; 
_crate addItemCargoGlobal ["rhs_acc_1p63", 1]; 
